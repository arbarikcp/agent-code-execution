...
| 02 | Action Spaces: Text, JSON, and Code | todo | |
...
Next chapter to implement: **Chapter 2 — Action Spaces: Text, JSON, and Code**
(Part I). Read its entry in `agent_code_execution_study_guide.md` before
starting; it does not depend on the (not-yet-built) backbone agent.
